...
![simple-input](https://github.com/asakatida/assets/raw/stable/go-prompt/examples/input.gif)

A simple echo example using `prompt.Input`.

## http-prompt

![http-prompt](https://github.com/asakatida/assets/raw/stable/go-prompt/examples/http-prompt.gif)

A simple [http-prompt](https://github.com/eliangcs/http-prompt) implementation using go-prompt in less than 200 lines of Go.

## live-prefix

![live-prefix](https://github.com/asakatida/assets/raw/stable/go-prompt/examples/live-prefix.gif)
